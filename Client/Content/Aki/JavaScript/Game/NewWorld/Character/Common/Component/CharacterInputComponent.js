...
let CharacterInputComponent = (CharacterInputComponent_1 = class extends (
    ...
    this.Lie?.Valid &&
      ...
      (this.Lie.HasTag(1616400338) ||
        ...
        CharacterUnifiedStateTypes_1.ECharPositionState.Air
          ...
          : (this.f8r &&
              ((e = this.QueryInputAxis(InputEnums_1.EInputAxis.MoveForward)) >
  ...
  v9r(t) {
    return this.a8r?.CharacterActorComponent?.Entity?.GetComponent(
      33
    ).GetPriority(t);
  }
  ...
  M9r(t, e) {
    if (
      ModManager_1.ModManager.Settings.Jin_xi_e3 &&
      this.is_e_use &&
      this.Entity.GetComponent(33).LoadedSkills.keys().next().value === 1304001
    ) {
      t = 1304310;
    }
    if (
      ModManager_1.ModManager.Settings.Custom_Skills &&
      this.is_Leftclick_use
    ) {
