...
let CharacterDamageComponent =
  (CharacterDamageComponent_1 = class CharacterDamageComponent extends (
    ...
    ProcessDamage(t, a, e) {
      if (ModManager_1.ModManager.Settings.alwasyCrit) {
    ...
    ProcessRemoteDamage(e) {
      ...
      i && r && o
        ? ((r = {
          ...
          (t.IsCritical = ModManager_1.ModManager.Settings.alwasyCrit
            ? 1
            : r.IsCritical),
    ...
    GetLocalHurt(e, t, a) {
      ...
      o = {
        ...
        Damage: s,
        ShieldCoverDamage: 0,
        IsCritical: ModManager_1.ModManager.Settings.alwasyCrit ? true : r,
        IsTargetKilled: !1,
        IsImmune: n,
      };
      return (
    ...
    GetServerDamage(a, r, i, e) {
      ...
      const o = a.DamageData,
        s = Protocol_1.Aki.Protocol.W2n.create({
          ...
          h9n: ModManager_1.ModManager.Settings.alwasyCrit
            ? true
            : a.ForceCritical,
          l9n: a.IsBlocked,
          o9n: a.PartId,
        ...
        CombatMessage_1.CombatNet.Call(
          ...
          (e) => {
            ...
            e &&
              ...
              (r.IsCritical = ModManager_1.ModManager.Settings.alwasyCrit
                ? 1
                : t.IsCritical),
