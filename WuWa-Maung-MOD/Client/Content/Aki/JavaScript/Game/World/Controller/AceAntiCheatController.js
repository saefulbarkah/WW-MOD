...
class AceAntiCheatController extends ControllerBase_1.ControllerBase {
  ...
  static OnTick(t) {
    ...
    //     i &&
    //       ((o = this.BTa.get(r).Woh).push(i), o.length > POSTICKCOUNT) &&
    //       (this.wTa = !1);
    //   }
    // }
  }
  ...
  static qTa(t) {
    ...
    //     ((e = Protocol_1.Aki.Protocol.qih.create()).kTa =
  ...
  static VTa(t) {
    // var e = Protocol_1.Aki.Protocol.xsh.create(),
  ...
  static XTa(t) {
    ...
    //     )
    //   : (((e = Protocol_1.Aki.Protocol.Nih.create()).kTa =
    //       MathUtils_1.MathUtils.BigIntToLong(t)),
  ...
  static oLa(t) {
    ...
    //   : (this.nLa(
    //       t,
    //       Protocol_1.Aki.Protocol.Ush.Proto_LogType_SecRoleFightFlow_BigWorldEnd
    //     ),
    //     (this.iLa = -1n));
  }
  static rLa() {
    ...
    //         (((e = Protocol_1.Aki.Protocol.bsh.create()).aLa = i.RoleId),
  ...
  static nLa(t, e) {
    ...
    //   var o,
    //     i = Protocol_1.Aki.Protocol.Vih.create(),
    //     r =
  ...
  static gLa(t) {
    ...
    //   : (this.nLa(
    //       t,
    //       Protocol_1.Aki.Protocol.Ush.Proto_LogType_SecRoleFightFlow_InstEnd
    //     ),
    //     (this.CLa = -1n));
  }
  static fLa(t, e) {
  ...
  static MLa(t) {
    ...
    //     ((e = Protocol_1.Aki.Protocol.$ih.create()).kTa =
    //       MathUtils_1.MathUtils.BigIntToLong(t)),
  ...
  static SLa(t) {
    ...
    //   : ((this.ELa = t),
    //     (this.OTa = Time_1.Time.WorldTime),
    //     ((e = Protocol_1.Aki.Protocol.Wih.create()).kTa =
    //       MathUtils_1.MathUtils.BigIntToLong(t)),
    //     (e.NTa = TimeUtil_1.TimeUtil.DateFormat2(new Date())),
    //     (o = this.YNr())
    //       ? ((e.FTa = o[0] ? this.VTa(o[0]) : void 0),
  ...
  static yLa(t) {
    ...
    //     )
    //   : ((this.ELa = -1n),
    //     ((e = Protocol_1.Aki.Protocol.Kih.create()).kTa =
    //       MathUtils_1.MathUtils.BigIntToLong(t)),
    //     (e.YTa = TimeUtil_1.TimeUtil.DateFormat2(new Date())),
    //     (e.JTa = Time_1.Time.WorldTime - this.OTa),
    //     (e.zTa = this.nun),
...
(exports.AceAntiCheatController = AceAntiCheatController),
  ...
  (AceAntiCheatController.ATa = (t) => {
    ...
    switch (t.mLa) {
      case Protocol_1.Aki.Protocol.Ush.Proto_LogType_SecGetReportData2Flow:
        break;
      case Protocol_1.Aki.Protocol.Ush.Proto_LogType_SecFBRoundStartFlow:
        _a.qTa(e);
        break;
      case Protocol_1.Aki.Protocol.Ush.Proto_LogType_SecFBRoundEndFlow:
        _a.XTa(e);
        break;
      case Protocol_1.Aki.Protocol.Ush
      ...
      case Protocol_1.Aki.Protocol.Ush
        ...
        _a.oLa(e);
        break;
      case Protocol_1.Aki.Protocol.Ush.Proto_LogType_SecRoleFightFlow_InstStart:
        _a.dLa(e);
        break;
      case Protocol_1.Aki.Protocol.Ush.Proto_LogType_SecRoleFightFlow_InstEnd:
        _a.gLa(e);
        break;
      case Protocol_1.Aki.Protocol.Ush.Proto_LogType_SecWorldInfoFlow_Start:
        _a.fLa(e, MathUtils_1.MathUtils.LongToNumber(t.xoh));
        break;
      case Protocol_1.Aki.Protocol.Ush.Proto_LogType_SecWorldInfoFlow_End:
        _a.MLa(e);
        break;
      case Protocol_1.Aki.Protocol.Ush.Proto_LogType_SecWorldStartFlow:
        _a.SLa(e);
        break;
      case Protocol_1.Aki.Protocol.Ush.Proto_LogType_SecWorldSEndFlow:
        _a.yLa(e);
        break;
      default:
        Log_1.Log.CheckError() &&
  ...
  (AceAntiCheatController.qbr = (t, e, o) => {
    ...
    // else
    //   Log_1.Log.CheckWarn() &&
    //     Log_1.Log.Warn('Net', 36, 'SetNewAttrMaxValue FightRoleInfoMap nil');
  }),
  (AceAntiCheatController.Uie = (t, e, o, i, r) => {
    ...
    // } else
    //   Log_1.Log.CheckWarn() &&
    //     Log_1.Log.Warn('Net', 36, 'OnDamage FightRoleInfoMap nil');
  }),
  ...
  (AceAntiCheatController.ReportDataRequest = () => {
    ...
    //   ((t = Protocol_1.Aki.Protocol.Oih.create()),
